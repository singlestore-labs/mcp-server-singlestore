[![MseeP.ai Security Assessment Badge](https://mseep.net/pr/singlestore-labs-mcp-server-singlestore-badge.png)](https://mseep.ai/app/singlestore-labs-mcp-server-singlestore)
