...
SINGLESTORE_ORG_ID = os.getenv("SINGLESTORE_ORG_ID")
SINGLESTORE_ORG_NAME = os.getenv("SINGLESTORE_ORG_NAME", "Default Organization")
...
# Auth
CLIENT_ID = os.getenv("CLIENT_ID", "b7dbf19e-d140-4334-bae4-e8cd03614485")
